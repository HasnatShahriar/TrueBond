...
//         if (res.data.modifiedCount > 0) {
//           refetch();
//           toast.success(`${user.name} is an Premium Now`)
//         }
//       })
//   }
...
//                   </td>
//                   <td className="px-3 py-2">
//                     {user.role === 'admin' ? 'Admin' : <button onClick={() => handleMakeAdmin(user)} className="px-4 py-3 font-semibold rounded dark:bg-gray-800 dark:text-gray-100 bg-orange-600"><FaUsers className="text-white text-2xl" /></button>}
//                   </td>
//                   <td className="px-3 py-2">
//                     { user.role === 'premium' ? 'Premium' :
//                       <button onClick={() => handleMakePremium(user)} className="px-4 py-3 font-semibold rounded dark:bg-gray-800 dark:text-gray-100 bg-pink-600"><FaUsers className="text-white text-2xl" /></button>
//                     }
//                   </td>
//                 </tr>)
//               }
