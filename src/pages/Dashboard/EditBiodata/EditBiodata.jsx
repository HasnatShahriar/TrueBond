    ...
    <div className="mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div className="form-group">
              ...
              >
                ...
                <option value="santals">Santals</option>
                <option value="rakhine">Rakhine</option>
                <option value="other_ethnic_groups_in_bangladesh">Other Ethnic Groups in Bangladesh</option>
              </select>
            </div>
        ...
        <div className="mt-4 text-center">
          <button type="submit" className="px-3 py-2 bg-[#FF6F61]  text-white rounded-md font-semibold hover:bg-[#e66558] focus:outline-none focus:ring-2 focus:ring-[#FF6F61]">
