...
// const Banner = () => {
//   return (
//     <Carousel autoPlay={true} interval={2500} infiniteLoop={true} showThumbs={false} showStatus={true}className="mb-20">
//       <div>
//         <img className="h-[500px]" src={img1} alt="Slide 1" />
//         <h2 className='text-5xl font-bold -mt-80 text-white'>Find Your Perfect Partner</h2>
//       </div>
//       <div>
